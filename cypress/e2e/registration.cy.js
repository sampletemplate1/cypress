describe('Registration functionality', () => {
    it('Register new user', () => {
        ...
        cy.get("input[id='customer.username").type('Harshi')
  ...
  //to understand automate registration functinality test case(use css selectors and then use type to type something and then click)